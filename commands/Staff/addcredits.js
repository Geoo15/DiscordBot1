...
module.exports.run = (client, message, args) => {
    ...
    const { addCredits, getCredits } = creditManager;
    ...
    var giveEmbed = new Discord.RichEmbed()
        ...
        .setDescription(`Added **${amount} credits** to user <@${toGive.id}>!`)
    ...
    var stockEmbed = new Discord.RichEmbed()
        ...
        .setTitle(`Credits Added`)
        .setDescription(`**<@${message.author.id}> Successfully added points to <@${toGive.id}>**`)
        .setColor("GREEN")
        .addField("**Staff user**", `** ${message.author.tag} **`)
        .addField("**Staff user ID**", `**${message.author.id}**`)
        .addField("**Amount added**", `**${amount}** credits`, true)
...
module.exports.help = {
    ...
    description: "Adds credits to a user.",
